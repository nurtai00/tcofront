      ...
      <div class="info__item first">
        <div class="info__item-right first firstfirst">
          ...
          <ul>
            ...
            <li><a href="#">ПБР-ПУБД</a></li>
            <li><a href="">Последние цифры и факты</a></li>
            <li><a href="">Показатели области ТБ ООС</a></li>
            <li><a href="">Отчет о корпоративной ответственности</a></li>
