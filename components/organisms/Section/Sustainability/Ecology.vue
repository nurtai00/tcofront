      ...
      items: [
        {
          ...
          description:'Процесс CHESM четко определяет обязанности сторон, обеспечивает эффективное взаимодействие с подрядными организациями и последовательное выполнение требований Программы CHESM в целях предотвращения травм и происшествий, связанных с нарушением требований БиОТ/ООС среди персонала подрядных организаций.',
        },
        {
          id: 2,
